...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Fenemy, function (sprite, otherSprite) {
    music.bigCrash.play()
    info.changeLifeBy(-1)
    enemydeath(otherSprite)
    scene.cameraShake(4, 500)
})
sprites.onOverlap(SpriteKind.Player, SpriteKind.plus1, function (sprite, otherSprite) {
...
sprites.onOverlap(SpriteKind.Projectile, SpriteKind.Fenemy, function (sprite, otherSprite) {
    sprite.destroy()
...
function spawnBenemy () {
    timer.throttle("action", randint(2000, 6000), function () {
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Benemy, function (sprite, otherSprite) {
    music.bigCrash.play()
    info.changeLifeBy(-2)
    enemydeath(otherSprite)
    scene.cameraShake(4, 500)
})
sprites.onOverlap(SpriteKind.Projectile, SpriteKind.Benemy, function (sprite, otherSprite) {
    sprite.destroy()
    statusbars.getStatusBarAttachedTo(StatusBarKind.BigEnemyHealth, otherSprite).value += -5
})
sprites.onOverlap(SpriteKind.sheild, SpriteKind.Fenemy, function (sprite, otherSprite) {
    enemydeath(otherSprite)
    info.changeScoreBy(1)
    myShield.destroy()
})
...
sprites.onOverlap(SpriteKind.sheild, SpriteKind.Benemy, function (sprite, otherSprite) {
    enemydeath(otherSprite)
    info.changeScoreBy(2)
    myShield.destroy()
})
